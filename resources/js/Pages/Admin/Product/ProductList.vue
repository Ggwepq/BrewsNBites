...
const addProduct = async () => {
    ...
    // Append product images in formData
    ...
    <section class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5">
        ...
        <el-dialog v-model="dialogVisible" :title="isEditingProduct ? 'Edit Product' : 'Add Product'" width="40%"
            ...
            <form @submit.prevent="isEditingProduct ? updateProduct() : addProduct()">
                ...
                <div class="relative z-0 w-full mb-5 group">
                    <input type="number" step="any" name="floating_price" id="floating_price"
                        class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                ...
                <div
                    ...
                    <div
                        ...
                        <button type="button" @click="openAddModal"
                            class="flex items-center justify-center text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-bue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
